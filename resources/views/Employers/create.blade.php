...
@section('content')		    
            ...
            <div class="row g-4 settings-section">
                <div class="col-12 col-md-4">
                    ...
                    <div class="section-intro">Ajouter un nouveau Employer</div>
                </div>
                    ...
                    <div class="app-card app-card-settings shadow-sm p-4">
                        ...
                        <div class="app-card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nom" value="{{old('nom')}}" class="form-control" id="setting-input-1">
                                    @error('nom')
                                ...
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Prenom(s)</label>
                                    <input type="text" name="prenom" value="{{old('prenom')}}" class="form-control" id="setting-input-2">
                                    @error('prenom')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control" id="setting-input-3" value="{{old('email')}}">
                                    @error('email')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="contact" class="form-control" id="setting-input-3" value="{{old('contact')}}">
                                    @error('contact')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="montant_journalier" value="{{old('montant_journalier')}}" class="form-control" id="setting-input-3">
